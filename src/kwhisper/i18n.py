...
_CATALOG: dict[str, dict[str, str]] = {
    "en": {
        ...
        "doctor.tts_piper_ok": "piper-tts importable",
        "doctor.tts_piper_fail": "piper-tts not importable (install the 'tts' extra)",
    ...
    "es": {
        ...
        "doctor.tts_piper_ok": "piper-tts importable",
        "doctor.tts_piper_fail": "piper-tts no importable (instala el extra 'tts')",
